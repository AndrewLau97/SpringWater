    ...
    <>
      ...
      <div className="font-georgia py-10  text-black">
        ...
        <p className="sm:w-1/2 sm:mx-auto mb-5 text-center mx-5">
          ...
          authentic Cantonese cuisine in a relaxed, family-friendly setting.
      ...
      >
        <div className="lg:w-1/2 py-10 lg:px-10 sm:px-20 px-10">
          <EventSlider
            images={["/images/Fountain.webp", "/images/Fountain2.webp"]}
            imageNames={[
        ...
        <div className="lg:w-1/2 flex flex-col justify-center">
          <div className="xl:w-2/3 text-center lg:mx-auto mx-10 font-georgia lg:w-4/5 md:w-2/3 md:mx-auto">
            <p className="mx-auto mb-5 text-lg">
              ...
              passion for great food and memorable dining experiences continues
              to delight both loyal fans and a new generation of food lovers.
            </p>
            <div>
          ...
          <div className="md:w-2/3 md:h-72 mx-auto xl:block hidden mt-10">
            <iframe
              ...
              title="Google Map to Springwater Cantonese"
            ></iframe>
          </div>
        </div>
      </div>
      ...
      >
          ...
          <div className="text-center my-10 md:my-0 xl:mx-20 sm:mx-10 gap-5 flex flex-col">
            ...
            <div>
              <p>
                ...
                entire week around Chinese New Year, experience the thrill of a
                live dragon dance right here in the restaurant — bringing good
                luck and festive energy to every visit!
              </p>
              <Link
            ...
            <div>
              <p>
                ...
                dance floor, dj and good vibes for friends and family to enjoy.
                Make your December weekends unforgettable with us!{" "}
              </p>
              <Link
                className="underline font-bold hover:cursor-pointer"
                to="/xmas-nye"
        ...
        <div className=" lg:w-1/2 py-10 lg:px-10 sm:px-20 px-10">
          <div className="w-4/5 mx-auto">
            <EventSlider
              images={[
                "/images/XmasDeco.webp",
                "/images/XmasDeco2.webp",
                "/images/CNYHorseBG.webp",
              ]}
              imageNames={[
      ...
      >
        <div className=" lg:w-1/2 py-10 lg:px-10 sm:px-20 px-10">
          <div className="w-4/5 mx-auto">
            <EventSlider
              images={[
                "/images/Balloons.webp",
                "/images/TableEvent.webp",
                "/images/TableEvent2.webp",
                "/images/CakeFlower.webp",
                "/images/RedEnvelope.webp",
                "/images/80Balloons.webp",
                "/images/80Balloons2.webp",
              ]}
              imageNames={[
